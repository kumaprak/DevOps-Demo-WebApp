...
public class acat {
	...
	public String URL = "http://3.14.13.163:8080/ProdWebapp";
	public String URL1 = "http://3.14.13.163:8080/ProdWebapp/avncreatepage.jsp";
	...
	public void checkin() {
		...
		// Login Page content check --- testing webhook
		//driver.findElement(By.xpath("//h1[text()='JUPITER COMMUNICATION']")).isDisplayed(); Git Poll test
